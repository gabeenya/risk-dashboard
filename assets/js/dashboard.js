...
function renderDash(k) {
  ...
  if (isJng) {
    ...
    // 매장 운영 관리 분류 전체 뷰 — 안전+클레임 합산 (위생은 위반율 개념이 없는 예외 영역이라 이 KPI 합산에서 제외, 등급은 3-3 측정판 참고)
